    ...
    >
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <View style={styles.inner}>
            ...
            <Text style={styles.description}>Refere-se à quantos reais custarão cada ponto?{'\n'}{'\n'}O padrão são R$ 0,08562667. Deseja alterar?</Text>
            <View style={styles.btnContainer}>
                <TouchableOpacity onPress={() => ir('teste7')}>
